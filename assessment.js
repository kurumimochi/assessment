...
function removeAllChildren(element) {
    while (element.firstChild) { // 子の要素を削除する
...
assessmentButton.onclick = () => {
    ...
    const hrefValue = 'https://twitter.com/intent/tweet?button_hashtag=YourPersonality&ref_src=twsrc%5Etfw';

    anchor.setAttribute('href', hrefValue);
    anchor.className = 'twitter-hashtag-button';
    anchor.setAttribute('data-text', result);
    anchor.innerText = 'Tweet #YourPersonality';
